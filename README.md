...
- [Node.js](https://nodejs.org/en/) (I've used version `v20.6.1` while writing this doc)
- npm (I've used version `9.7.1` while writing this doc)
...
Made with ❤️ by [Arlan](https://github.com/arlangmoura/cypress-e2e).
